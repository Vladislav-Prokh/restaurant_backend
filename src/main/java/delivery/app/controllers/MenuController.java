...
public class MenuController {
	...
	@PostMapping("/lunches")
	public void addLunch(@RequestBody LunchRequestDTO lunch) {
		menuService.saveLunch(lunch);
	}

	@PostMapping("/additionals")
	public void addAdditional(@RequestBody BeverageAdditional addition) {
		menuService.saveBeverageAdditional(addition);
	}
	...
	@DeleteMapping("/additionals/{additional-id}")
	public void deleteAdditional(@PathVariable("additional-id") Long additional_id) {
		menuService.deleteBeverageAdditional(additional_id);
	}
}
