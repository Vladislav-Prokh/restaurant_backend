...
public class OrderService {
	...
	public OrderResponseDTO saveOrder(OrderRequestDTO orderDTO) {
	    ...
	    Beverage orderedBeverage = orderDTO.getBeverageId() != null ? fetchBeverage(orderDTO.getBeverageId()) : null;
	    Lunch lunch = orderDTO.getLunchId() != null ? fetchLunch(orderDTO.getLunchId()) : null;
