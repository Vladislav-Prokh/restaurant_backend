   ...
   @Test
    public void testGetBeverages() throws Exception {
        ...
        mockMvc.perform(get("/menu/beverages")
                ...
                .andExpect(jsonPath("$.content[0].beverageName").value("Coke"));
    ...
    public void testGetLunches() throws Exception {
        ...
        mockMvc.perform(get("/menu/lunches")
                            ...
                            .param("size", String.valueOf(size)))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.content[0].mainCourse.mealName").value("grilled chicken breast"))
                    .andExpect(jsonPath("$.content[0].dessert.dessertName").value("Chocolate Cake"));
